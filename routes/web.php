...
Route::group(['namespace' => 'Auth'], function () {
  ...
  Route::get('/user/registration/{ref?}', [
    'uses' => 'RegisterController@redirectToUserRegistrationProcess',
    'as'   => 'user-registration-page'
  ]);

  Route::get('/user/verifyaccount/{code?}', [
    'uses' => 'RegisterController@userVerifyAccount',
    'as'   => 'user-verify-account-page'
  ]);
  ...
  Route::post('/user/registration/{ref?}', [
...
Route::group(['prefix' => 'admin'], function () {
  ...
  Route::get('delivery_areas', [
    'uses' => 'Admin\UserController@deliveryAreasContent',
    'as'   => 'admin.delivery_areas_content'
  ])->middleware('verifyLoginPage', 'admin', 'sufficientPermission');

  Route::get('delivery_area/delete/{id}', [
    'uses' => 'Admin\UserController@deliveryAreaDelete',
    'as'   => 'admin.delivery_area_delete'
  ])->middleware('verifyLoginPage', 'admin', 'sufficientPermission');

  Route::get('delivery_areas/add', [
    'uses' => 'Admin\UserController@addDeliveryAreaContent',
    'as'   => 'admin.add_delivery_area_content'
  ])->middleware('verifyLoginPage', 'admin', 'sufficientPermission');

  Route::get('delivery_area/edit/{id}', [
    'uses' => 'Admin\UserController@editDeliveryAreaContent',
    'as'   => 'admin.edit_delivery_area_content'
  ])->middleware('verifyLoginPage', 'admin', 'sufficientPermission');
  ...
  Route::get('banners/add', [
    'uses' => 'CMSController@bannerAdd',
    'as'   => 'admin.add_banner'
  ])->middleware('verifyLoginPage', 'admin', 'sufficientPermission');
  ...
  Route::get('allorders', [
    'uses' => 'OrderController@allOrderListsContent',
    'as'   => 'admin.all_shop_orders_list'
  ])->middleware('verifyLoginPage', 'admin', 'sufficientPermission');
...
Route::group(['prefix' => 'admin'], function () {
  ...
  Route::post('/delivery-area/add', [
    'uses' => 'Admin\AdminAjaxController@saveDeliveryArea',
    'as'   => 'save-delivery-area'
  ]);



  Route::post('/banners/save', [
    'uses' => 'Admin\AdminAjaxController@saveBanners',
    'as'   => 'save-banners'
  ]);

  Route::post('/delivery-area/edit', [
    'uses' => 'Admin\AdminAjaxController@editDeliveryArea',
    'as'   => 'edit-delivery-area'
  ]);
...
Route::get('/ajax/search_products', [
  'uses' => 'Frontend\FrontendAjaxController@searchProductsByFilterWithName',
  'as'   => 'get-products-by-search'
]);
...
Route::get('/ajax/remove-from-cart/{id}', [
  'uses' => 'Frontend\FrontendAjaxController@productRemoveFromCart',
...
Route::get('/ajax/cart-total', [
  'uses' => 'Frontend\FrontendAjaxController@cartTotal',
  'as'   => 'cat-total-amount'
]);
...
Route::get('/finalize-checkout/{order_id}/{process_id}/{payment_gateway}', [
  'uses' => 'CheckoutController@finalizeCheckout',
  'as'   => 'finalize-checkout-page'
]);

Route::post('/finalize-checkout/{order_id}/{process_id}/{payment_gateway}', [
  'uses' => 'CheckoutController@finalizeCheckout',
  'as'   => 'finalize-checkout-page'
]);
...
Route::group(['prefix' => 'user', 'namespace' => 'Frontend'], function () {
  ...
  Route::get('account/my-refferals', [
    'uses' => 'UserAccountManageController@userRefferalsPageContent',
    'as'   => 'my-refferals-page'
  ])->middleware('userAdmin', 'verifyLoginPage');

  Route::get('account/open-ticket', [
    'uses' => 'UserAccountManageController@userRefferalsPageContent',
    'as'   => 'open-ticket'
  ])->middleware('userAdmin', 'verifyLoginPage');
