...
class UserController extends Controller
{
  ...
  /**
   * 
   * delivery areas list content
   *
   * @param null
   * @return response view
   */
  public function deliveryAreasContent()
  {
    $data = array();
    $search_value = '';
    ...
    return view('pages.admin.delivery.delivery_areas_list', $data);
  }
  
  public function deliveryAreaDelete($item_id){
      if( isset($item_id) && !empty($item_id)){
          $deliveryArea = DeliveryArea::find($item_id);
          $deliveryArea->delete();
      } 
   ...
   * @return response view
   */
  public function addDeliveryAreaContent()
  {
    $data = array();
    $search_value = '';
    ...
    return view('pages.admin.delivery.add_delivery_area', $data);
  }

  public function editDeliveryAreaContent($id = null)
  {
    $data = array();
    $search_value = '';
    ...
    if ($id != null) {
      $data['delivery_zone'] = DeliveryArea::find($id);
      return view('pages.admin.delivery.edit_delivery_area', $data);
    }
  }
