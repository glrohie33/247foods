...
class OptionController extends Controller
{
  ...
  public function getPaymentMethodData(){
    ...
    if(!empty($get_payment_option)){
      ...
      $get_payment['paystack']['enable_option'] = "1";
      $get_payment['paystack']['method_title'] = "Paystack";
      $get_payment['paystack']['method_description'] = "Paystack payment gateway with cards";
      $get_payment['paystack']['method_instructions'] = "Paywithcard";
      $get_payment['paystack']['method_title'] = "Paystack";
      $get_payment['gtpay']['enable_option'] = "1";
      $get_payment['gtpay']['method_title'] = "Gtpay";
      $get_payment['gtpay']['method_description'] = "Gtpay payment gateway with cards";
      $get_payment['gtpay']['method_instructions'] = "Paywithcard";
    }
