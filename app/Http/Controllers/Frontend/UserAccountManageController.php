...
class UserAccountManageController extends Controller
{
  ...
  public function userAccountPageContent()
  {
    ...
    $data['ref_link'] = "/user/registration/" . base64_encode($get_current_user_id['user_id']);
  ...
  public function userRefferalsPageContent()
  {
    $data = array();
    ...
    $data['all_refferals'] = User::where(['referee' => $user_id])->get();
