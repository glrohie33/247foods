...
class FrontendManagerController extends Controller
{
  ...
  public function productCategoriesSinglePageContent($params)
  {
    ...
    if (count($get_cat_product_and_breadcrumb) > 0) {
      ...
      return view('pages.frontend.frontend-pages.topdeal-category', $data);
    } else {
      return redirect('/');
    }
  }
  ...
  public function blogSinglePageContent($params)
  {
    ...
    if (count($get_blog_details_by_slug) > 0 && isset($get_blog_details_by_slug['post_status']) && $get_blog_details_by_slug['post_status'] == 1) {
      ...
      return view('pages.frontend.frontend-pages.top-blog-single-page', $data);
    } else {
      return redirect('/');
    }
  }
   ...
   * @return void 
   */
  public function productsPageContent($params = null)
  {
    $data = array();
    $sort = null;
    $price_min = null;
    ...
    if (count($get_product) > 0) {
      ...
      $data['all_products_details']['type'] = $params;

      return view('pages.frontend.frontend-pages.topdeals-shop-list', $data);
    } else {
      return redirect('/');
    }
  }
  ...
  public function checkoutPageContent()
  {
    ...
    return view('pages.frontend.frontend-pages.topdealcheckout', $data);
  }
  ...
  public function thankyouPageContent($params, $params2)
  {
    ...
    return view('pages.frontend.frontend-pages.order-details', $data);
  }
