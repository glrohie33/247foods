<a href="" class="main show-mini-cart" data-id="2"><div style="position:relative;"><img src="{{ asset('public/images/cart3.png') }}" alt=""> <i id="total_count_by_ajax">{!! Cart::count() !!} </i></div> <div><p class="">{!! trans('frontend.menu_my_cart') !!}</p></div> </a>
