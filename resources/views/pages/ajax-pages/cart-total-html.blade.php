        ...
        @elseif(($shipping_data['shipping_option']['enable_shipping']) && ($shipping_data['flat_rate']['enable_option'] || $shipping_data['free_shipping']['enable_option'] || $shipping_data['local_delivery']['enable_option']) )
          ...
          @elseif($shipping_data['shipping_option']['display_mode'] == 'dropdown')
            ...
            @elseif($shipping_data['local_delivery']['enable_option'] && $shipping_data['local_delivery']['fee_type'] === 'per_weight' && $shipping_data['local_delivery']['delivery_fee'])
              @if(Cart::getShippingMethod()['shipping_method'] == 'local_delivery')
                 <?php $str .= '<option selected value="local_delivery">'. Lang::get('frontend.local_delivery') .': '. price_html( get_product_price_html_by_filter(Cart::getLocalDeliveryShippingPerProductWeight()), get_frontend_selected_currency() ) .'</option>';?>
              @else
                 <?php $str .= '<option value="local_delivery">'. Lang::get('frontend.local_delivery') .': '. price_html( get_product_price_html_by_filter(Cart::getLocalDeliveryShippingPerProductWeight()), get_frontend_selected_currency() ) .'</option>';?>
              @endif
            @endif
            @if($str)
