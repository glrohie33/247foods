          ...
          <div style="width: 100%;">
            ...
            <br>
              ...
              <div class="col-sm-6">
                ...
                @if($order_details_by_order_id['_delivery_zone'])
                    <p> <strong>Delivery Zone</strong>: {{  $order_details_by_order_id['_delivery_zone']}}</p>
                @endif
                @if($order_details_by_order_id['_delivery_area'])
                    <p> <strong>Delivery Area</strong>: {{ $order_details_by_order_id['_delivery_area']}}</p>
                @endif
                @if($order_details_by_order_id['_delivery_date'])
                    <p> <strong>Delivery Date</strong>: {{ $order_details_by_order_id['_delivery_date']}}</p>
                @endif
                @if($order_details_by_order_id['_delivery_time'])
                    <p> <strong>Delivery Time</strong>:{{  $order_details_by_order_id['_delivery_time'] }}</p>
                @endif
              </div>
      </div>
    </div>
