...
@elseif (Request::is('user/account/my-refferals'))
  @section('title',  trans('My Refferals') .' < '. get_site_title() )  
@elseif (Request::is('user/account/open-ticket'))
  @section('title',  trans('Open Ticket') .' < '. get_site_title() ) 
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-3">
      <div class="account-tab-main">
        <ul class="nav flex-column">
          ...
          @if(Request::is('user/account/my-refferals'))
            <li class="nav-item"><a class="nav-link active" href="{{ route('my-refferals-page') }}"><i class="fa fa-user"></i> {{ trans('My Refferals') }}</a></li>
          @else
            <li class="nav-item"><a class="nav-link" href="{{ route('my-refferals-page') }}"><i class="fa fa-user"></i> {{ trans('My Refferals') }}</a></li>
          @endif
          
          @if(Request::is('user/account/open-ticket'))
            <li class="nav-item"><a class="nav-link active" href="javascript:void(Tawk_API.toggle())"><i class="fa fa-user"></i> {{ trans('Open Ticket') }}</a></li>
          @else
            <li class="nav-item"><a class="nav-link" href="javascript:void(Tawk_API.toggle())"><i class="fa fa-user"></i> {{ trans('Open Ticket') }}</a></li>
          @endif
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-9">
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          ...
          @elseif(Request::is('user/account/my-refferals') )
            @include('pages.frontend.user-account.my-refferals')  
          @elseif(Request::is('user/account/order-details/*') )
