  ...
  <div class="box-body">
    <div class="row">
      ...
      <div class="col-md-4">
        ...
        <br>
        @if($order_data_by_id['_delivery_zone'])
              <p> <strong>Delivery Zone</strong>: {{  $order_data_by_id['_delivery_zone']}}</p>
          @endif
          @if($order_data_by_id['_delivery_area'])
              <p> <strong>Delivery Area</strong>: {{ $order_data_by_id['_delivery_area']}}</p>
          @endif
          @if($order_data_by_id['_delivery_date'])
              <p> <strong>Delivery Date</strong>: {{ $order_data_by_id['_delivery_date']}}</p>
          @endif
          @if($order_data_by_id['_delivery_time'])
              <p> <strong>Delivery Time</strong>:{{  $order_data_by_id['_delivery_time'] }}</p>
          @endif
            ...
            <tbody>
              ...
              <tr>
                <td colspan="5" class="order-total">
                  ...
                  <p class=""><strong>Coupon Code</strong>{!!  $order_data_by_id['_order_coupon_code']  !!}</p>
