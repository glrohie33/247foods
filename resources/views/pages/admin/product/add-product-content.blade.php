      ...
      <div class="box box-solid">
        ...
        <div class="box-body">
          <div class="uploaded-product-image">
            ...
            <div class="product-uploaded-image"><img class="img-responsive"><input type='text' placeholder="alt" name="" onkeyup="setAlt('product-image','',this.value)" class="form-control"> <div class="remove-img-link"><button type="button" data-target="product_image" class="btn btn-default attachtopost">{!! trans('admin.remove_image') !!}</button></div></div>
          </div>
      ...
      <div class="box box-solid">
        ...
        <div class="box-body">
          <div class="uploaded-banner-image">
            ...
            <div class="banner-uploaded-image"><img class="img-responsive"><input type='text' placeholder="alt" name="" onkeyup="setAlt('shop-banner','',this.value)" class="form-control"><div class="remove-img-link banner-img-remove"><button type="button" class="btn btn-default attachtopost">{!! trans('admin.remove_image') !!}</button></div></div>
          </div>
              ...
              <div class="tab-general tab-pane fade show active" id="tab_general">  
                ...
                <div class="form-group">
                  <div class="row">
                    ...
                    <div class="col-sm-6">
                      <input type="number" placeholder="Product Weight" id="inputWeight" name="inputWeight" class="form-control" min="0" step="any" value="{{ old('inputWeight') }}"> 
                    </div>
                  </div>  
                </div>
                <div class="form-group">
