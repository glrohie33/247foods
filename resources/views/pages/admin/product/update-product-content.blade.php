      ...
      <div class="box box-solid">
        ...
        <div class="box-body">
          <div class="uploaded-product-image">
              <?php
              $product_images = $product_post_data['_product_related_images_url'];
              ?>
            ...
            <div class="product-uploaded-image" style="display:block;"><img class="img-responsive" src="{{ get_image_url($product_post_data['_product_related_images_url']->product_image) }}"><div class="remove-img-link">
              <input type='text'  placeholder="alt" value="<?=isset($product_images->product_image_alt)?$product_images->product_image_alt:'';?>" name="" onkeyup="setAlt('product-image','',this.value)" class="form-control">
              <button type="button" data-target="product_image" class="btn btn-default attachtopost">{!! trans('admin.remove_image') !!}</button></div></div>
            @else
            ...
            <div class="product-uploaded-image" style="display:none;"><img class="img-responsive"><div class="remove-img-link">
                <input type='text'  placeholder="alt" value="" name="" onkeyup="setAlt('product-image','',this.value)" class="form-control">
              <button type="button" data-target="product_image" class="btn btn-default attachtopost">{!! trans('admin.remove_image') !!}</button></div></div>
            @endif
          </div>
        ...
        <div class="box-body">
          <div class="uploaded-product-gallery-image">
            ...
            <div class="product-uploaded-gallery-image" style="display:block;">
              ...
              <div class="gallery-image-single-container"><img class="img-responsive" src="{{ get_image_url($data->url) }}">
                <input type='text'  placeholder="alt" value="<?=isset($data->alt)?$data->alt:'';?>" name="" onkeyup="setAlt('product-image','<?=$data->id?>',this.value)" class="form-control">
                <div data-id="{{ $data->id }}" class="remove-gallery-img-link"></div></div>
              @endforeach
            </div>
          ...
          <div class="tabbable tabs-left">
            ...
            <div class="tab-content">
              <div class="tab-general tab-pane fade {{ $tabSettings['generalTab'] }}" id="tab_general">
                ...
                <div class="form-group">
                  <div class="row">
                    <label class="col-sm-6 control-label" for="inputSalePrice">Weight (kg)</label>
                    <div class="col-sm-6">
                      <input type="number" placeholder="Product Weight" id="inputWeight" name="inputWeight" class="form-control" min="0" step="any" value="{{ $product_post_data['product_weight'] }}"> 
                    </div>
                  </div>  
                </div>
                ...
                <div class="form-group">
                  <div class="row">
                    <label class="col-sm-6 control-label" for="inputType">Product Type</label>
                    <div class="col-sm-6">
                     <select class="form-control" name="inputType" value="{{ old('inputType') }}">
                       <option value="">Select Product Type</option>
                       <option value="vendor" <?= ($product_post_data['product_type'] == 'vendor' ) ? 'selected':'';?> >Vendor</option>
                       <option value="local market" <?= ($product_post_data['product_type'] == 'local market' ) ? 'selected':'';?>>Local Market</option>
                     </select>
                    </div>
                  </div>  
                </div>
              ...
              <div class="tab-advanced tab-pane fade" id="tab_advanced">
                ...
                <div class="form-group">
                  <div class="row">
                    <label class="col-sm-6 control-label" for="inputEnableBestSelling">Enable As Best Selling</label>
                    <div class="col-sm-6">
                        @if( isset($product_post_data['_product_enable_as_best_selling']) && $product_post_data['_product_enable_as_best_selling'] == 'yes')
                            <input type="checkbox"  checked="checked" class="shopist-iCheck" name="enable_best_selling_product" id="enable_best_selling_product">
                        @else
                            <input type="checkbox" class="shopist-iCheck" name="enable_best_selling_product" id="enable_best_selling_product">
                        @endif
                        &nbsp; Enable As Best Selling
                    </div>
                  </div>
                </div>
                <div class="form-group">
                    <div class="row">  
                      <label class="col-sm-6 control-label" for="inputEnableTodaysDealProduct">Enable Todays Deal Product</label>
                      <div class="col-sm-6">
                        @if( isset($product_post_data['_product_enable_todays_deal']) && $product_post_data['_product_enable_todays_deal'] == 'yes')
                          <input type="checkbox" checked="checked" class="shopist-iCheck" name="enable_todays_deal_product" id="enable_todays_deal_product">
                        @else
                          <input type="checkbox" class="shopist-iCheck" name="enable_todays_deal_product" id="enable_todays_deal_product">
                        @endif
                        &nbsp;Product Enable Todays Deal                                    
                      </div>
                    </div>  
                  </div>
                <div class="form-group">
...
<script>
    function setAlt(where,id,value){
      // console.log(`id: ${id}; value: ${value}`);
      shopist.normalFunction.update_product_img_alt_in_json_data(where,id,value);
    }
  </script>
@endsection