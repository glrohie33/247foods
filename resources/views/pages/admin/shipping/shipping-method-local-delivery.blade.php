            ...
            <div class="row">  
              ...
              <div class="col-sm-6">
                <select name="inputLocalDeliveryFeeType" id="inputLocalDeliveryFeeType" class="form-control select2" style="width: 100%;">
                  ...
                  @if($shipping_method_data['local_delivery']['fee_type'] == 'per_weight')
                   <option selected="selected" value="per_weight">Amount Per Weight</option>
                  @else
                   <option value="per_weight">Amount Per Weight</option>
                  @endif
                </select>
              </div>
            </div>    
