            ...
            <div class="row">  
              ...
              <div class="col-sm-8">
                <select id="change_conditions_type" name="change_conditions_type" class="form-control select2" style="width: 100%;">
                  ...
                  @endif
                  <option value="discount_from_shipping"  <?=($coupon_update_data['coupon_condition_type'] == 'discount_from_shipping')? "selected='selected'":'';?>>{{ trans('discount from shipping') }}</option>
                  <option value="percentage_discount_from_shipping" <?=($coupon_update_data['coupon_condition_type'] == 'percentage_discount_from_shipping')? "selected='selected'":'';?>>{{ trans('% discount from shipping') }}</option>
