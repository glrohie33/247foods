        ...
        <form method="post" class="form-horizontal" action="" enctype="multipart/form-data">
          ...
          <div class="box box-info">
            ...
            <div class="box-body">
              ...
              <div class="form-group">
                <div class="row">
                    <label class="col-sm-4 control-label" >{{ 'slider links'}}</label>
                  <div class="col-sm-8 slider_links">

                    @if(count(get_appearance_header_settings_data()) > 0)
                    <?php $i= 1;?>

                    @foreach(get_appearance_header_settings_data() as $slider_img)
                    <div id="{{ $slider_img->id }}" >
                          <label>Slider {{ $i }}</label>
                          <input type="text" class="form-control" value="{{ $slider_img->link }}" onkeyup="setLink('{{ $slider_img->id }}',this.value)">
                    </div>
              ...
              <script>
                function setLink(id,value){
                  ...
                  shopist.normalFunction.update_frontend_img_link_in_json_data(id,value);
                }
              </script>
<!--              <div class="form-group">
                <div class="row">    
