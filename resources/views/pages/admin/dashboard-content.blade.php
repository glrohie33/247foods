...
<div class="row">
  <div class="col-lg-3 col-xs-12">
    <div class="small-box bg-gray">
      ...
      <!--<a href="{{ route('admin.shop_current_date_orders_list')}}" class="small-box-footer">{{ trans('admin.more_info') }} <i class="fa fa-arrow-circle-right"></i></a>-->
              <a class="small-box-footer">{{ trans('') }} <i class="fa fa-first-order"></i></a>
    </div>
  </div>
  <div class="col-lg-3 col-xs-12">
  ...
  <div class="col-lg-3 col-xs-12">
    <div class="small-box bg-green">
      ...
      <!--<a href="{{ route('admin.shop_current_date_orders_list') }}" class="small-box-footer">{{ trans('') }} <i class="fa fa-first-order"></i></a>-->
        <a class="small-box-footer">{{ trans('') }} <i class="fa fa-first-order"></i></a>
    </div>
  </div>
  <div class="col-lg-3 col-xs-12">
