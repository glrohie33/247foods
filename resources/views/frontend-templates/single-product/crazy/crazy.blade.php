      ...
      <div class="row">
        <div class="col-12">  
          <ul class="nav nav-tabs">
              <li class="nav-item"><a class="nav-link active" href="#productDetails" data-toggle="tab">Product Details</a></li>
            <li class="nav-item"><a <?php if(!old('comments_target')){?>class="nav-link " <?php }?> href="#features" data-toggle="tab">{{ trans('frontend.features_label') }}</a></li>  
