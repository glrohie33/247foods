<div id="header_content">
                  ...
                  @else
                    <a class="dropdown-toggle" href="#" data-hover="dropdown" data-toggle="dropdown">
                      {{-- <img src="{{ get_image_url(get_frontend_selected_languages_data()['lang_sample_img']) }}" alt="lang"> --}}
                       {{-- <span class="d-none d-md-inline"> &nbsp; {!! get_frontend_selected_languages_data()['lang_name'] !!}</span> <span class="caret"></span>
                    </a>
                  @endif
                @endif --}}
  ...
  <div class="header-content-bottom-all" id="sticky_nav">  
    <div class="header-content-middle">
      <div class="container">
        ...
        <div class="col-md-3 col-sm-6 logo-cover">
            @if(get_site_logo_image())
              <div class="logo text-center"><a href="/"><img src="{{ get_site_logo_image() }}" title="{{ trans('frontend.your_store_label') }}" alt="{{ trans('frontend.your_store_label') }}"></a></div>
            @endif
        </div>
        <div class="col-md-5 col-sm-12 normal-search text-center search-and-compare-item">
          ...
          <div class="items-compare-list"><a href="{{ route('product-comparison-page') }}" class="btn btn-light btn-compare"><i class="fa fa-exchange"></i></a></div>  
        </div>

        <div class="col-md-4 col-sm-6 text-center header-cart">
            <li class="users-vendors-login dropdown"><a href="#" class="main selected dropdown-toggle" data-toggle="dropdown" data-hover="dropdown"><img src="{{ asset('public/images/profile.png') }}" alt="" srcset=""> <span class="d-none d-md-inline">Login<span class="caret"></span></a>
              <div class="new-dropdown-menu dropdown-content my-account-menu">
                ...
                @if (Session::has('shopist_admin_user_id') && !empty(get_current_vendor_user_info()['user_role_slug']) && get_current_vendor_user_info()['user_role_slug'] == 'vendor')
                 <a target="_blank" href="{{ route('admin.dashboard') }}">Sell at 247foods</a>
                @else
                 <a target="_blank" href="{{ route('admin.login') }}">Sell at 247foods</a>
                @endif
        ...
        <div class="col-md-12 col-sm-12 mobile-search text-center search-and-compare-item">
            <div class="terms-search-option">  
              <form id="search_option" action="{{ route('shop-page') }}" method="get">
                <div class="input-group">
                  <input type="text" id="srch_term" name="srch_term" class="form-control" placeholder="{{ trans('frontend.search_for_label') }}">
        ...
        <div class="row">
          <div class="col-12">
            <nav class="navbar navbar-expand-lg navbar-dark nav-main" id="navbar">
              ...
              <svg viewbox=" 0 0 30 30" id="mobile-svg">
                  <use href="{{ asset("public/images/menu.svg#Capa_1") }}" ></use>
                </svg>
              </button>
