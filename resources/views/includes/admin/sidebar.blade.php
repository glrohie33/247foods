  ...
  <section class="sidebar">
    <ul class="sidebar-menu"> 
      ...
      @if(in_array('manage_orders_list', $user_permission_list))
        ...
        @if(Request::is('admin/allorders') || Request::is('admin/orders/details/*') || Request::is('admin/orders/current-date'))
          <li class="active">
            <a href="{{ route('admin.all_shop_orders_list') }}">
              <i class="fa fa-file-text-o"></i> <span>{!! trans('admin.all_orders') !!}</span>
            </a>
          </li>
        @else
          <li>
      ...
      @if(in_array('manage_delivery_area_access',$user_permission_list))
          @if(Request::is('admin/delivery_areas'))
           <li class="active treeview">
              <a href="#">
                  <i class="fa fa-cog"></i> <span> Delivery Area</span> <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
                  <li><a href="{{ route('admin.delivery_areas_content') }}"><i class="fa fa-circle-o"></i> All Delivery</a></li>
                  <li><a href="{{ route('admin.add_delivery_area_content') }}"><i class="fa fa-flag-o"></i> Add New Delivery Zone</a></li>
                </ul>
            </li> 
          @else
            <li class=" treeview">
      ...
      @if($sidebar_data['is_vendor_login'] == false)
        @if(Request::is('admin/banners/add'))
          <li class="active">
            <a href="{{ route('admin.add_banner') }}" class="active">
              <i class="fa fa-file-image-o"></i> <span>Add Banners</span>
            </a>
          </li>
        @else
          <li>
            <a href="{{ route('admin.add_banner') }}">
              <i class="fa fa-file-image-o"></i> <span>Add Banners</span>
            </a>
          </li>
        @endif
