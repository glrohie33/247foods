...
<link rel="stylesheet" href="{{ URL::asset('public/bootstrap/css/bootstrap4.min.css') }}" />
...
<script type="text/javascript" src="{{ URL::asset('public/bootstrap/js/bootstrap4.min.js') }}"></script>   
